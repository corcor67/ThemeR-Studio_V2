...
cp ~/apktool/framework/1.apk ~/apktool/framework/old-1.apk
cp ~/apktool/framework/2.apk ~/apktool/framework/old-2.apk
cp place-framework-resources/framework-res.apk ~/apktool/framework/1.apk
rm place-framework-resources/framework-res.apk
find "place-framework-resources" -name *.apk | while read other_apk
do
cp $other_apk ~/apktool/framework/2.apk
done
}
...
restart () {
	...
	echo "  19   Push apktool resources"
	echo "  20   Quit"
	echo "****************************************************************************"
	printf "%s" "Please make your decision: "
	read ANSWER
